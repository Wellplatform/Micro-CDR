...
UCDR_ARRAY_DEFINITIONS(_uint8_t, STRINGIFY(uint8_t), 1)
UCDR_ARRAY_DEFINITIONS(_uint16_t, STRINGIFY(uint16_t), 2)
UCDR_ARRAY_DEFINITIONS(_uint32_t, STRINGIFY(uint32_t), 4)
UCDR_ARRAY_DEFINITIONS(_uint64_t, STRINGIFY(uint64_t), 8)
UCDR_ARRAY_DEFINITIONS(_int8_t, STRINGIFY(int8_t), 1)
UCDR_ARRAY_DEFINITIONS(_int16_t, STRINGIFY(int16_t), 2)
UCDR_ARRAY_DEFINITIONS(_int32_t, STRINGIFY(int32_t), 4)
UCDR_ARRAY_DEFINITIONS(_int64_t, STRINGIFY(int64_t), 8)
